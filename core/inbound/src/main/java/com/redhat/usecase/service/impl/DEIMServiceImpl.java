...
public class DEIMServiceImpl implements DEIMService {
	...
	public Response addPerson(Person person) {
		...
		return demoProcess(person, headers);
	}
	...
	@Path("/other")
	@Consumes(MediaType.APPLICATION_XML)
	public Response otherAction(Person person) {
		// This header is used to direct the message in the Camel route
		Map<String, Object> headers = new HashMap<String, Object>();
		headers.put("METHOD", "other");
		return demoProcess(person, headers);
	}

	private Response demoProcess(Person person, Map<String, Object> headers) {
		ResponseBuilderImpl builder = new ResponseBuilderImpl();

		try {
			String camelResponse = 
					template.requestBodyAndHeaders(
							template.getDefaultEndpoint(), person, headers,	String.class);
